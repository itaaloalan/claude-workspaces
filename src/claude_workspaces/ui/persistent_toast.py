...
class PersistentToast(QWidget):
    ...
    def __init__(
        ...
        card.setStyleSheet(
            ...
            "QLabel#toastBody { color: #c9c6c0; font-size: 12px; }"
            "QPushButton#toastOpen {"
            "  background: #c08f3d; color: #fff; border: 0;"
            "  border-radius: 3px; padding: 4px 10px; font-size: 12px;"
            "}"
            "QPushButton#toastOpen:hover { background: #4a8ad8; }"
            "QPushButton#toastSecondary {"
            "  background: #302d27; color: #c9c6c0; border: 0;"
            "  border-radius: 3px; padding: 4px 8px; font-size: 11px;"
            "}"
            "QPushButton#toastSecondary:hover { background: #302d27; color: #fff; }"
            "QPushButton#toastClose {"
            "  background: transparent; color: #8b8880; border: 0;"
...
class FlashToast(QWidget):
    ...
    def __init__(self, message: str, parent: QWidget | None = None) -> None:
        ...
        card.setStyleSheet(
            "#flashCard {"
            "  background: #2d2b26;"
            "  border: 1px solid #c08f3d;"
            "  border-left: 3px solid #c08f3d;"
            "  border-radius: 4px;"
            "}"
