...
class PersistentToast(QWidget):
    ...
    def __init__(
        ...
        card.setStyleSheet(
            ...
            "QLabel#toastBody { color: #c6c6c6; font-size: 12px; }"
            "QPushButton#toastOpen {"
            "  background: #e8e8e8; color: #fff; border: 0;"
            "  border-radius: 3px; padding: 4px 10px; font-size: 12px;"
            "}"
            "QPushButton#toastOpen:hover { background: #4a8ad8; }"
            "QPushButton#toastSecondary {"
            "  background: #4f4f4f; color: #c6c6c6; border: 0;"
            "  border-radius: 3px; padding: 4px 8px; font-size: 11px;"
            "}"
            "QPushButton#toastSecondary:hover { background: #4f4f4f; color: #fff; }"
            "QPushButton#toastClose {"
            "  background: transparent; color: #7f7f7f; border: 0;"
