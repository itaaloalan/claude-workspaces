...
class PersistentToast(QWidget):
    ...
    def __init__(
        ...
        card.setStyleSheet(
            ...
            "QLabel#toastBody { color: #b8b8b8; font-size: 12px; }"
            "QPushButton#toastOpen {"
            "  background: #d9d9d9; color: #fff; border: 0;"
            ...
            "}"
            "QPushButton#toastSecondary:hover { background: #2b2b2b; color: #fff; }"
            "QPushButton#toastClose {"
            "  background: transparent; color: #757575; border: 0;"
