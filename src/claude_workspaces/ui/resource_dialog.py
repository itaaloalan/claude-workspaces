...
_STOP_BTN_QSS = (
    ...
    "border: 1px solid #4f4f4f; border-radius: 4px; padding: 2px 10px; "
    "font-size: 11px; }"
...
_FREE_BTN_QSS = (
    ...
    "border: 1px solid #4f4f4f; border-radius: 5px; padding: 5px 14px; "
...
class ResourceDialog(QDialog):
    ...
    def _update_row(self, h: dict, g: ProcGroup) -> None:
        ...
        if color != h["color"]:
            bar.setStyleSheet(
                "QProgressBar { background: #2a2a2a; border: 0; border-radius: 3px; }"
        ...
        if expanded:
            ...
            detail.setStyleSheet(
                "QFrame { background: #2c3037; border: 1px solid #3a3a3a; "
