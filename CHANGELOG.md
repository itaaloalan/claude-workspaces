...
### Ajuste visual
- `WorkspaceItemWidget`: removida borda `1px solid` do workspace selecionado — seleção passa a ser apenas pill cinza sutil (`rgba(255,255,255,12)`) sem contorno, consistente com o console filho selecionado.
